  ...
  void initState() {
    ...
    for( int a =0; a < searchBusApi.searchBusData!.busData.length; a++){
        if (searchBusApi.searchBusData!.busData.isNotEmpty) {
          ...
          searchBusApi.isLoading ? CircularProgressIndicator(color: notifier.purplecolor) : reviewList.add(false);
                                            ...
                                            children: [
                                              Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        const Icon(Icons.star_rate_rounded,color: Colors.white,size: 12,),
                                                        const SizedBox(width: 3),
                                                        Text(searchBusApi.searchBusData!.busData[index].busRate,style: const TextStyle(
                                                          fontFamily: 'SofiaLight',
                                                          color: Colors.white,
                                                          fontSize: 10,
                                                        ),),
                                ...
                                Column(
                                  children: [
                                        ...
                                        InkWell(
                                            onTap: () {
                                              if (searchBusApi.searchBusData!.busData[index].totalReview != 0) {
                                                if (reviewList[index] == false) {
                                                  for(int a = 0; a < reviewList.length; a++){
                                                    if (reviewList.contains(true)) {
                                                      reviewList[a] = false;
                                                      setState((){});
                                                    }
                                                  }
                                    ...
                                    seatSelectionOpen[index]
                                        ? Divider(color: notifier.lightgreycolor,) : const SizedBox(),
                                    seatSelectionOpen[index]
                                        ? SeatSelection(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        const Icon(Icons.star_rate_rounded,color: Colors.white,size: 12,),
                                                        const SizedBox(width: 3),
                                                        Text(searchBusApi.searchBusData!.busData[index2].busRate,style: const TextStyle(
                                                            fontFamily: 'SofiaLight',
                                                            color: Colors.white,
                                                            fontSize: 10,
                                                            ),),
                                    ...
                                    gridviewList.contains(index2)
                                      ...
                                      child: Container(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          physics: const NeverScrollableScrollPhysics(),
                                          itemCount: reviewListApi.reviewlistData!.reviewdata.length,
                                          itemBuilder: (buildContextcontext, index1) {
                                            return Column(
                                                crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                                children: [
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            Padding(
                                                              ...
                                                              const EdgeInsets.all(12),
                                                              child:
                                                              Text(reviewListApi.reviewlistData!.reviewdata[index1].userTitle[0], style: TextStyle(fontFamily: 'SofiaLight', color: notifier.purplecolor, fontSize: 14)),
                                                            ),
                                                          ),
                                                          const SizedBox(width: 5),
                                                          Column(
                                                            ...
                                                            CrossAxisAlignment.start,
                                                            children: [
                                                              Text(reviewListApi.reviewlistData!.reviewdata[index1].userTitle,
                                                                  style: TextStyle(fontFamily: 'SofiaLight', fontWeight: FontWeight.w600, color: notifier.blackcolor, fontSize: 14)),
                                                              const SizedBox(height: 2),
                                                              Text(reviewListApi.reviewlistData!.reviewdata[index1].reviewDate.toString().split(' ').first,
                                                                  style: TextStyle(fontFamily: 'SofiaLight', color: notifier.blackcolor, fontSize: 12)),
                                                            ],
                                                          ),
                                                        ],
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              Icon(Icons.star_rate_rounded,
                                                                  color: notifier.purplecolor,
                                                                  size: 12),
                                                              Text(reviewListApi.reviewlistData!.reviewdata[index1].userRate,
                                                                  style: TextStyle(fontFamily: 'SofiaLight', fontWeight: FontWeight.w600, color: notifier.purplecolor, fontSize: 10)),
                                                            ],
                                                          ),
                                                        ),
                                                  ...
                                                  Text(
                                                      reviewListApi.reviewlistData!.reviewdata[index1].userDesc,
                                                      style: TextStyle(
                                                          fontFamily:
                                                          'SofiaLight',
                                                          color: notifier
